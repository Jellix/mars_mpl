...
package body Gtk.Gauge.LED_Round is
   ...
   -- Background_Color : constant Gdk_Color := Gtk.Missed.RGB (0.5, 0.5, 0.5);
   ...
   protected Lock is
      function On_Color
        (LED : Gtk_Gauge_LED_Round_Record'Class) return Gdk.Color.Gdk_Color;
   ...
   protected body Lock  is
      function Off_Color
        (LED : Gtk_Gauge_LED_Round_Record'Class)  return Gdk.Color.Gdk_Color is
      begin
         return LED.Off;
      end Off_Color;
      ...
      Widget.all.Shadow :=
        Gtk.Layered.Line.Add_Line
          (Under    => Widget.all.Background.all.Get_Foreground,
           ...
           Widened  => True,
           Color    =>
             Gdk.Color.IHLS.Darken (Lock.Off_Color (Widget.all), Shadow_Shift));

        ...
        (Glib.Types.Class_Ref (Class_Record.all.The_Type),
         Glib.Properties.Creation.Gnew_Uint
           (Name    => "waveform-proximity",
            ...
            Default => 10,
            Blurb   =>
              "The waveform poximity area used to detect " &
        ...
        (Glib.Types.Class_Ref (Class_Record.all.The_Type),
         Glib.Properties.Creation.Gnew_Uint
           (Name       => "time-axis-height",
            ...
            Blurb      =>
              "The height of the box under or above " &
        ...
        (Glib.Types.Class_Ref (Class_Record.all.The_Type),
         Glib.Properties.Creation.Gnew_Uint
           (Name       => "time-text-border",
            ...
            Blurb      =>
              "The space added to text annotation " &
        ...
        (Glib.Types.Class_Ref (Class_Record.all.The_Type),
         Glib.Properties.Creation.Gnew_Int
           (Name       => "time-text-overlap",
            ...
            Blurb      =>
              "The overlapping of time annotation " &
        ...
        (Glib.Types.Class_Ref (Class_Record.all.The_Type),
         Glib.Properties.Creation.Gnew_Uint
           (Name       => "values-axis-width",
            ...
            Blurb      =>
              "The width of the box left or right " &
        ...
        (Glib.Types.Class_Ref (Class_Record.all.The_Type),
         Glib.Properties.Creation.Gnew_Int
           (Name       => "values-text-overlap",
            ...
            Blurb      =>
              "The overlapping of values annotation " &
              "text boxes. The value is added to the " &
              "box left and top margins and " &
              "subtracted from the right and bottom " &
              "margins. If the obtained box overlaps " &

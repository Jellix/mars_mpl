...
package Gtk.Tree_Model.Abstract_Store is
   ...
   function Children
     (Model  : not null access Gtk_Abstract_Model_Record;
      Parent : Gtk_Tree_Iter) return Gtk_Tree_Iter is abstract;
   ...
   --
   procedure Finalize
     (Model : not null access Gtk_Abstract_Model_Record) is null;
   ...
   function Get_Column_Type
     (Model : not null access Gtk_Abstract_Model_Record;
      Index : Gint) return GType is abstract;
   ...
   function Get_Iter
     (Model : not null access Gtk_Abstract_Model_Record;
      Path  : Gtk_Tree_Path) return Gtk_Tree_Iter is abstract;
   ...
   function Get_Path
     (Model : not null access Gtk_Abstract_Model_Record;
      Iter  : Gtk_Tree_Iter) return Gtk_Tree_Path is abstract;
   ...
   function Has_Child
     (Model : not null access Gtk_Abstract_Model_Record;
      Iter  : Gtk_Tree_Iter) return Boolean is abstract;
   ...
   procedure Next
     (Model : not null access Gtk_Abstract_Model_Record;
      Iter  : in out Gtk_Tree_Iter) is abstract;
   ...
   function Nth_Child
     (Model  : not null access Gtk_Abstract_Model_Record;
      ...
      N      : Gint) return Gtk_Tree_Iter is abstract;
   ...
   function N_Children
     (Model : not null access Gtk_Abstract_Model_Record;
      Iter  : Gtk_Tree_Iter := Null_Iter) return Gint is abstract;
   ...
   function Parent
     (Model : not null access Gtk_Abstract_Model_Record;
      Child : Gtk_Tree_Iter) return Gtk_Tree_Iter is abstract;
...
private
   ...
   function Register_Type
     (Name       : String;
      ...
      Signals    : Gtkada.Types.Chars_Ptr_Array := Gtkada.Types.Null_Array;
      Parameters : Signal_Parameter_Types       := Null_Parameter_Types) return GType;

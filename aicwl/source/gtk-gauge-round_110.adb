...
package body Gtk.Gauge.Round_110 is
   ...
   Area_Color        : constant Gdk.Color.Gdk_Color := Gtk.Missed.RGB (0.0, 0.2, 0.3);
   Line_Color        : constant Gdk.Color.Gdk_Color := Gtk.Missed.RGB (0.8, 1.0, 1.0);
   ...
   procedure Create_Background
     (Widget  : not null access Gtk_Gauge_Round_110_Record'Class;
      Sectors : Positive) is
   begin
      ...
      Widget.all.Arrows_Area :=
        Gtk.Layered.Elliptic_Background.Add_Elliptic_Background
          (Under         => Widget.all.Background.all.Get_Foreground,
           ...
           Border_Shadow => Gtk.Enums.Shadow_In,
           Deepened      => True,
           Widened       => True,
           Scaled        => True);
      Widget.all.Line_1 :=
      ...
      Widget.all.Minor_Ticks :=
        Gtk.Layered.Elliptic_Scale.Add_Elliptic_Scale
          (Under   => Widget.all.Background.all.Get_Foreground,
           ...
           Width   => 1.0 / 400.0,
           Skipped => 5,
           Step    => Span / (10.0 * Gdouble (Widget.all.Sectors)),
           From    => First  + Offset,
           Length  => Span,
           Scaled  => True,
           Widened => True);
      Widget.all.Middle_Ticks :=
        Gtk.Layered.Elliptic_Scale.Add_Elliptic_Scale
          (Under   => Widget.all.Background.all.Get_Foreground,
           ...
           Width   => 1.0 / 400.0,
           Skipped => 2,
           Step    => Span / (2.0 * Gdouble (Widget.all.Sectors)),
           From    => First  + Offset,
           Length  => Span,
           Scaled  => True,
           Widened => True);
      Widget.all.Major_Ticks :=
        Gtk.Layered.Elliptic_Scale.Add_Elliptic_Scale
          (Under   => Widget.all.Background.all.Get_Foreground,
           ...
           Width   => 2.0 / 400.0,
           Step    => Span / Gdouble (Widget.all.Sectors),
           From    => First  + Offset,
           Length  => Span,
           Scaled  => True,
           Widened => True);
   ...
   overriding procedure Style_Changed
     (Widget : not null access Gtk_Gauge_Round_110_Record) is
   begin

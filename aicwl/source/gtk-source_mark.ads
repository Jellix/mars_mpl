...
package Gtk.Source_Mark is
   ...
   type Gtk_Source_Mark_Record is
     new Gtk.Text_Mark.Gtk_Text_Mark_Record with private;
   ...
   --
   function Convert (Mark : System.Address) return Gtk_Source_Mark;

   function Convert (Mark : Gtk_Source_Mark) return System.Address;
...
private
   ...
   type Gtk_Source_Mark_Record is
     new Gtk.Text_Mark.Gtk_Text_Mark_Record with null record;

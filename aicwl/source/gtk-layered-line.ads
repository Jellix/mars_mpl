...
package Gtk.Layered.Line is
   ...
   function Add_Line
     (Under    : not null access Layer_Location'Class;
      ...
      Line_Cap : Cairo.Cairo_Line_Cap       := Cairo.Cairo_Line_Cap_Butt;
      Scaled   : Boolean                    := False;
      Widened  : Boolean                    := False) return not null access Line_Layer;
   ...
   --
   function Get_From (Layer : Line_Layer) return Cairo.Ellipses.Cairo_Tuple;
   ...
   --    The line end point
   --
   function Get_To (Layer : Line_Layer) return Cairo.Ellipses.Cairo_Tuple;
   ...
   overriding function Get_Scaled (Layer : Line_Layer) return Boolean;

   overriding function Get_Widened (Layer : Line_Layer) return Boolean;

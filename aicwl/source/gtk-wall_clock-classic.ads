   ...
   type Gtk_Wall_Clock_Classic_Record is
     new Gtk.Layered.Gtk_Layered_Record with
      record
         ...
         Line_1        : access Gtk.Layered.Arc.Arc_Layer;
         Line_2        : access Gtk.Layered.Arc.Arc_Layer;
         Line_3        : access Gtk.Layered.Arc.Arc_Layer;
         Pin_1         : access Gtk.Layered.Elliptic_Background.Elliptic_Background_Layer;
         Pin_2         : access Gtk.Layered.Elliptic_Background.Elliptic_Background_Layer;
         ...
         Second_Ticks  : access Gtk.Layered.Elliptic_Scale.Elliptic_Scale_Layer;

...
package Gtk.Valve.Round_90 is
   ...
   function Get_Needle
     (Widget : not null access Gtk_Valve_Round_90_Record)
      return not null access Gtk.Layered.Disk_Needle.Disk_Needle_Layer;
   ...
   type Gtk_Valve_Round_90_Record is
     new Gtk.Layered.Gtk_Layered_Record with
      record
         ...
         Left_Cover  : access Gtk.Layered.Sector_Needle.Sector_Needle_Layer;
         Right_Cover : access Gtk.Layered.Sector_Needle.Sector_Needle_Layer;
         Needle      : access Gtk.Layered.Disk_Needle.Disk_Needle_Layer;
      end record;

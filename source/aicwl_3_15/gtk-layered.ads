...
package Gtk.Layered is
   ...
   is
      record
         case Shape is
         when Sector  => Center : Cairo.Ellipses.Cairo_Tuple;
         when Bagel   => Arc    : Cairo.Ellipses.Ellipse_Parameters;
         when Segment => null;
         end case;
      end record;
   ...
   procedure Add
     (Layer : not null access Layer_Object;
      Under : not null access Layer_Location'Class) is abstract;
   ...
   function Get_Markup
     (Layer    : Annotation_Layer;
      Position : Positive) return Boolean is abstract;
   ...
   function Get_Text
     (Layer    : Annotation_Layer;
      Position : Positive) return UTF8_String is abstract;
   ...
   procedure Set_Text
     (Layer    : in out Annotation_Layer;
      Position : Positive;
      Text     : UTF8_String;
      Markup   : Boolean := False) is abstract;
   ...
   function Get_Aspect_Ratio
     (Widget : not null access constant Gtk_Layered_Record) return Gdouble;
   ...
   --
   function Get_Depth
     (Widget : not null access constant Gtk_Layered_Record) return Natural;
   ...
   procedure Style_Changed
     (Widget : not null access Gtk_Layered_Record) is null;
   ...
   --
   overriding procedure Finalize (Layer : in out Abstract_Layer);
   ...
   function Find_Property
     (Layer      : Abstract_Layer'Class;
      Name       : String;
      Constraint : GType := GType_Invalid) return Natural;
   ...
   function Find_Property
     (Layer      : Abstract_Layer'Class;
      Constraint : Param_Spec) return Natural;
   ...
   function Get_Property_Specification
     (Layer    : Abstract_Layer;
      Property : Positive) return Param_Spec is abstract;
   ...
   function Get_Property_Value
     (Layer    : Abstract_Layer;
      Property : Positive) return Glib.Values.GValue is abstract;
   ...
   procedure Move
     (Layer  : in out Abstract_Layer;
      Offset : Cairo.Ellipses.Cairo_Tuple) is abstract;
   ...
   procedure Restore
     (Stream : in out Ada.Streams.Root_Stream_Type'Class;
      Layer  : in out Abstract_Layer) is abstract;
   ...
   procedure Set_Property_Value
     (Layer    : in out Abstract_Layer;
      Property : Positive;
      Value    : Glib.Values.GValue) is abstract;
   ...
   procedure Store
     (Layer   : in out Abstract_Layer;
      Context : Cairo.Cairo_Context) is null;
   ...
   procedure Store
     (Stream : in out Ada.Streams.Root_Stream_Type'Class;
      Layer  : Abstract_Layer) is abstract;
   ...
   type Gtk_Layered_Record is
     new Gtk_Drawing_Area_Record and Layer_Location with
      record
         ...
         Drawing_Time  : Ada.Real_Time.Time         := Ada.Real_Time.Clock;
      end record;

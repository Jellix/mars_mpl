...
package body Gtk.Meter.Round_90 is
   ...
   function Get_Annotation
     (Widget : not null access Gtk_Meter_Round_90_Record)
   ...
   overriding procedure Style_Changed
     (Widget : not null access Gtk_Meter_Round_90_Record) is
   begin

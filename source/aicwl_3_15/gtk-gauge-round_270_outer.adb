...
package body Gtk.Gauge.Round_270_Outer is
   ...
   procedure Create_Background
     (Widget  : not null access Gtk_Gauge_Round_270_Outer_Record'Class;
      Sectors : Positive) is
   begin
      ...
      Widget.all.Minor_Ticks :=
        Gtk.Layered.Elliptic_Scale.Add_Elliptic_Scale
          (Under   => Widget.all.Background.all.Get_Foreground,
           ...
           Width   => 1.0 / 200.0,
           Skipped => 2,
           Step    => 0.25 * Length / Gdouble (Widget.all.Sectors),
           From    => First,
           Length  => Length,
           Scaled  => True,
           Widened => True);
      Widget.all.Middle_Ticks :=
        Gtk.Layered.Elliptic_Scale.Add_Elliptic_Scale
          (Under   => Widget.all.Background.all.Get_Foreground,
           ...
           Width   => 2.3 / 200.0,
           Skipped => 2,
           Step    => 0.5 * Length / Gdouble (Widget.all.Sectors),
           From    => First,
           Length  => Length,
           Scaled  => True,
           Widened => True);
   ...
   overriding procedure Style_Changed
     (Widget : not null access Gtk_Gauge_Round_270_Outer_Record) is
   begin

...
package Gtk.Layered.Rectangular_Clip_Region is
   ...
   function Get_Rotation_Angle
     (Layer : Rectangular_Clip_Region_On_Layer) return Gdouble;
   ...
   overriding function Get_Scaled
     (Layer : Rectangular_Clip_Region_On_Layer) return Boolean;
   ...
   overriding procedure Restore
     (Stream : in out Ada.Streams.Root_Stream_Type'Class;
      Layer  : in out Rectangular_Clip_Region_Off_Layer) is null;
   ...
   overriding procedure Store
     (Stream : in out Ada.Streams.Root_Stream_Type'Class;
      Layer  : Rectangular_Clip_Region_Off_Layer) is null;

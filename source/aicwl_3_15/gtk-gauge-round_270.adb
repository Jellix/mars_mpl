...
package body Gtk.Gauge.Round_270 is
   ...
   Background_Color  : constant Gdk.Color.Gdk_Color := Gtk.Missed.RGB (0.1, 0.1, 0.1);
   Line_Color        : constant Gdk.Color.Gdk_Color := Gtk.Missed.RGB (0.5, 0.5, 0.5);
   ...
   overriding procedure Style_Changed
     (Widget : not null access Gtk_Gauge_Round_270_Record) is
   begin
      Widget.all.Needle.all.Set
        (Center => Widget.all.Needle.all.Get_Center,
         ...
         Color  =>
           Gtk.Widget.Styles.Style_Get (Widget, "needle-color", Arrow_Color));

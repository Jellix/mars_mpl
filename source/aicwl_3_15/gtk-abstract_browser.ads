...
package Gtk.Abstract_Browser is
   ...
   type Gtk_Abstract_Directory_Record is
     abstract new Gtk.Tree_Model.Abstract_Store.Gtk_Abstract_Model_Record
   with private;
   ...
   function Compare
     (Store   : not null access Gtk_Abstract_Directory_Record;
      Directory : Item_Path;
      A, B      : Directory_Item;
      By_Name   : Boolean) return Gtk.Missed.Row_Order is abstract;
   ...
   function Get_Directory
     (Store : not null access Gtk_Abstract_Directory_Record;
      Item  : Item_Path) return Item_Path is abstract;
   ...
   function Get_Name
     (Store : not null access Gtk_Abstract_Directory_Record;
      Item  : Item_Path) return Item_Name is abstract;
   ...
   function Get_Path
     (Store     : not null access Gtk_Abstract_Directory_Record;
      Directory : Item_Path;
      Name      : Item_Name) return Item_Path is abstract;
   ...
   function Get_Tree_Store
     (Store : not null access Gtk_Abstract_Directory_Record)
      return Gtk.Tree_Store.Gtk_Tree_Store;
   ...
   function Rewind
     (Store   : not null access Gtk_Abstract_Directory_Record;
      Directory : Item_Path) return Directory_Item is abstract;
   ...
   function Get_Name
     (Widget       : not null access Gtk_Directory_Tree_View_Record;
      ...
      Expanded     : Boolean;
      Has_Children : Boolean;
      Topmost      : Boolean) return Item_Name;
   ...
   function Is_Editable
     (Widget : not null access Gtk_Directory_Tree_View_Record) return Boolean;
   ...
   function Get_Icon
     (Widget       : not null access Gtk_Directory_Items_View_Record;
      ...
      Kind         : Item_Type;
      Directory    : Boolean;
      Has_Children : Boolean) return Icon_Data;
   ...
   function Get_Name
     (Widget : not null access Gtk_Directory_Items_View_Record;
      Index  : Positive) return Item_Name;
   ...
   function Get_Path
     (Widget : not null access Gtk_Directory_Items_View_Record;
      Name   : Item_Name) return Item_Path;
   ...
   function Get_Path
     (Widget : not null access Gtk_Directory_Items_View_Record;
      Index  : Positive) return Item_Path;
   ...
   function Get_Type
     (Widget : not null access Gtk_Directory_Items_View_Record;
      Index  : Positive) return Item_Type;
   ...
   overriding function Get_N_Columns
     (Model : not null access Gtk_Abstract_Directory_Record) return Gint;
...
private
   ...
   function "="
     (Left : Item_Path_Reference; Right : Item_Path) return Boolean;

   function "="
     (Left : Item_Path; Right : Item_Path_Reference) return Boolean;
   ...
   ------------------------------------------------------------------------
   type Gtk_Abstract_Directory_Record is
     abstract new Gtk.Tree_Model.Abstract_Store.Gtk_Abstract_Model_Record with
      record
         Refreshing : Natural := 0;
         Depth      : Natural := 0;        -- Cache recursion depth
         Tracing    : Traced_Actions := 0; -- Cache tracing enabled
         Tree       : Gtk.Tree_Store.Gtk_Tree_Store;      -- Unfiltered store
         Low, High  : Gdouble;             -- Caching progress range
         Last_Time  : Ada.Calendar.Time;   -- Progress was signaled
      end record;
   --
   ...
   type Gtk_Directory_Tree_View_Record is
     new Gtk.Tree_View.Gtk_Tree_View_Record with
      record
         ...
         Name_Renderer : Gtk.Cell_Renderer_Text.Gtk_Cell_Renderer_Text;
         Icon_Renderer : Gtk.Cell_Renderer_Pixbuf.Gtk_Cell_Renderer_Pixbuf;
   ...
   package Tree_Functions is
     new Gtk.Missed.Set_Column_Cell_Data (Gtk_Directory_Tree_View);
   ...
   type Gtk_Selection_Store_Record is
     new Gtk.Tree_Model.Extension_Store.Gtk_Extension_Store_Record with
      record
         Selected : Natural                      := 0;     -- Total rows selected
         Changed  : Boolean                      := False; -- Transient selection change flag
         Mode     : Gtk.Enums.Gtk_Selection_Mode := Gtk.Enums.Selection_Multiple;
   ...
   type Gtk_Directory_Items_Store_Record is
     new Gtk.Tree_Model.Abstract_Store.Gtk_Abstract_Model_Record with
      record
         Cache   : Gtk_Abstract_Directory;
         View    : Gtk_Directory_Items_View;
         Root    : Gtk.Tree_Model.Gtk_Tree_Path; -- Current root unfiltered
   ...
   procedure Gtk_New
     (Model : out Gtk_Directory_Items_Store;
      ...
      View  : not null access Gtk_Directory_Items_View_Record'Class);
   ...
   procedure From_Filtered
     (Model      : not null access Gtk_Directory_Items_Store_Record;
      ...
      Filtered   : Gtk.Tree_Model.Gtk_Tree_Iter);
   ...
   overriding function Get_N_Columns
     (Model : not null access Gtk_Directory_Items_Store_Record) return Gint;
   ...
   function To_Filtered
     (Model      : not null access Gtk_Directory_Items_Store_Record;
      Unfiltered : Gtk.Tree_Model.Gtk_Tree_Iter) return Gtk.Tree_Model.Gtk_Tree_Iter;
   ...
   type Gtk_Cell_Renderer_Text_Array is
     array (Integer range <>) of Gtk.Cell_Renderer_Text.Gtk_Cell_Renderer_Text;
   ...
   type Gtk_Directory_Items_View_Record is
     new Gtk.Tree_View.Gtk_Tree_View_Record with
      record
         ...
         Columns        : Gtk.Tree_Model.Columned_Store.Gtk_Columned_Store;
   ...
   package Column_Functions is
     new Gtk.Missed.Set_Column_Cell_Data (Column_Data);
   ...
   subtype Cached_Directory is Gint range
     Cached_Never_Directory .. Cached_Expanded_Directory;

   subtype Cached_Children is Gint range
     Cached_Ahead_Directory .. Cached_Expanded_Directory;

...
package Gtk.Layered_Editor is
   ...
   --
   type Gtk_Layered_Editor_Record is
     new Gtk.Widget.Gtk_Widget_Record with private;
   type Gtk_Layered_Editor is access all Gtk_Layered_Editor_Record'Class;
   ...
   procedure Gtk_New
     (Widget   : out Gtk_Layered_Editor;
      Layered  : access Gtk.Layered.Gtk_Layered_Record'Class := null);
...
private
   ...
   type Layer_Ptr is access all Gtk.Layered.Abstract_Layer'Class;
   ...
   package Layered_References is
     new GLib.Object.Strong_References (Gtk.Layered.Gtk_Layered_Record);
   ...
   private
      ...
      type Gtk_Enum_Record is new Boxes.Gtk_Enum_Combo_Box_Record with
         record
            No     : Property_Index;
            Widget : Gtk_Layered_Editor;
         end record;

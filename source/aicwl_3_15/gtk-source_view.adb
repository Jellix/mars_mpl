...
package body Gtk.Source_View is
   ...
   pragma Warnings (Off, "declaration hides ""Enable""");
   pragma Warnings (Off, "declaration hides ""Flags""");
   pragma Warnings (Off, "declaration hides ""Priority""");
   pragma Warnings (Off, "declaration hides ""Smart_Home_End""");
   pragma Warnings (Off, "declaration hides ""Widget""");
   pragma Warnings (Off, "declaration hides ""Width""");
   ...
   is
      function Internal (Widget : System.Address) return Interfaces.C.unsigned;
   ...
   is
      function Internal (Widget : System.Address) return Gboolean;
      pragma Import (C, Internal, "gtk_source_view_get_highlight_current_line");
   begin
      return 0 /= Internal (Get_Object (Widget));
   ...
   is
      function Internal
        (Widget   : System.Address;
         ...
         Priority : Gint) return System.Address;
      pragma Import (C, Internal, "gtk_source_view_get_mark_attributes");
      Stub : Gtk.Source_Mark_Attributes.Gtk_Source_Mark_Atributes_Record;
   begin
      return
        Gtk.Source_Mark_Attributes.Gtk_Source_Mark_Atributes
          (Get_User_Data_Fast
             (Internal
                (Get_Object (Widget),
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_source_view_get_right_margin_position");
   begin
      return Internal (Get_Object (Widget));
   ...
   is
      function Internal (Widget : System.Address) return Gboolean;
      pragma Import (C, Internal, "gtk_source_view_get_show_line_marks");
   begin
      return 0 /= Internal (Get_Object (Widget));
   ...
   is
      function Internal (Widget : System.Address) return Gboolean;
      pragma Import (C, Internal, "gtk_source_view_get_show_line_numbers");
   begin
      return 0 /= Internal (Get_Object (Widget));
   ...
   is
      function Internal (Widget : System.Address) return Gboolean;
      pragma Import (C, Internal, "gtk_source_view_get_show_right_margin");
   begin
      return 0 /= Internal (Get_Object (Widget));
   ...
   is
      function Internal (Widget : System.Address) return Interfaces.C.int;
   ...
   is
      use type Gtk.Source_Buffer.Gtk_Source_Buffer;
   begin
      if Buffer = null then
         declare
         ...
         declare
            ...
            pragma Import (C, Internal, "gtk_source_view_new_with_buffer");
         begin
   ...
   procedure Set_Highlight_Current_Line
     (Widget : not null access Gtk_Source_View_Record;
      Show   : Boolean)
   is
      procedure Internal (Widget : System.Address; Enable : Gboolean);
      pragma Import (C, Internal, "gtk_source_view_set_highlight_current_line");
   begin
      if Show then
         Internal (Get_Object (Widget), 1);
      else
   ...
   procedure Set_Indent_Width
     (Widget : not null access Gtk_Source_View_Record;
      Width  : Gint := -1)
   is
      procedure Internal (Widget : System.Address; Width : Gint);
   ...
   is
      procedure Internal
        (Widget     : System.Address;
         ...
         Priority   : Gint);
      pragma Import (C, Internal, "gtk_source_view_set_mark_attributes");
   begin
      Internal
        (Get_Object (Widget),
         Interfaces.C.To_C (Category),
   ...
   procedure Set_Right_Margin_Position
     (Widget   : not null access Gtk_Source_View_Record;
      Position : Guint)
   is
      procedure Internal (Widget : System.Address; Pos : Guint);
      pragma Import (C, Internal, "gtk_source_view_set_right_margin_position");
   begin
   ...
   is
      procedure Internal (Widget : System.Address; Enable : Gboolean);
      pragma Import (C, Internal, "gtk_source_view_set_show_line_marks");
   begin
      if Show then
         Internal (Get_Object (Widget), 1);
      else
   ...
   is
      procedure Internal (Widget : System.Address; Enable : Gboolean);
      pragma Import (C, Internal, "gtk_source_view_set_show_line_numbers");
   begin
      if Show then
         Internal (Get_Object (Widget), 1);
      else
   ...
   is
      procedure Internal (Widget : System.Address; Enable : Gboolean);
      pragma Import (C, Internal, "gtk_source_view_set_show_right_margin");
   begin
      if Show then
         Internal (Get_Object (Widget), 1);
      else
   ...
   is
      procedure Internal (Widget         : System.Address;
                          Smart_Home_End : Interfaces.C.int);
   ...
   procedure Set_Tab_Width
     (Widget : not null access Gtk_Source_View_Record;
      Width  : Guint)
   is
      procedure Internal (Widget : System.Address; Width : Guint);
   ...
   pragma Warnings (On, "declaration hides ""Enable""");
   pragma Warnings (On, "declaration hides ""Flags""");
   pragma Warnings (On, "declaration hides ""Priority""");
   pragma Warnings (On, "declaration hides ""Smart_Home_End""");
   pragma Warnings (On, "declaration hides ""Widget""");
   pragma Warnings (On, "declaration hides ""Width""");

...
package Gtk.Layered.Waveform is
   ...
   procedure Backward
     (Source : in out Waveform_Data_Scanner;
      T      : in out X_Axis;
      V      : out Y_Axis) is abstract;

   procedure Backward
     (Source : in out Waveform_Data_Scanner;
      T      : in out X_Axis;
      V      : out Y_Axis;
      Got_It : out Boolean) is abstract;
   ...
   function Is_In
     (Source : Waveform_Data_Scanner;
      T      : X_Axis) return Boolean is abstract;
   ...
   procedure Connected
     (Source : in out Waveform_Data_Source;
      Layer  : in out Waveform_Layer'Class) is abstract;
   ...
   --
   function Is_Active
     (Sweeper : not null access Waveform_Sweeper) return Boolean is abstract;
   ...
   --    The box
   --
   function Get_Box (Layer : Waveform_Layer) return Cairo.Ellipses.Cairo_Box;
   ...
   --
   function Get_Source
     (Layer : Waveform_Layer) return access Waveform_Data_Source'Class;
   ...
   function Get_Source
     (Scanner : Waveform_Data_Scanner)
      return not null access Waveform_Data_Source'Class is abstract;
   ...
   overriding function Get_Scaled (Layer : Waveform_Layer) return Boolean;

   overriding function Get_Widened (Layer : Waveform_Layer) return Boolean;

   overriding function Is_Updated (Layer : Waveform_Layer) return Boolean;

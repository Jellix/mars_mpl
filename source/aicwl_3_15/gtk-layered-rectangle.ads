...
package Gtk.Layered.Rectangle is
   ...
   --    The box
   --
   function Get_Box (Layer : Rectangle_Layer) return Cairo.Ellipses.Cairo_Box;
   ...
   --    The color
   --
   function Get_Color (Layer : Rectangle_Layer) return Gdk.Color.Gdk_Color;
   ...
   overriding function Get_Scaled (Layer : Rectangle_Layer) return Boolean;

   overriding function Get_Widened (Layer : Rectangle_Layer) return Boolean;

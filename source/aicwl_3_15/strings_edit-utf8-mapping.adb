...
package body Strings_Edit.UTF8.Mapping is
   ...
   Case_Map : constant Categorization_Array :=
   ...
   procedure Find
     (Code  : UTF8_Code_Point;
      ...
      Index : in out Categorization_Index)
   is
      From : Categorization_Index := Case_Map'First;
      To   : Categorization_Index := Case_Map'Last;
      This : Categorization_Index;
      Current : Code_Point;
   begin
      loop
         This := (From + To) / 2;
         Current := Case_Map (This).Code;
   ...
   begin
      ...
      if Found then
         return
           Case_Map (Index).Lower = Value or else
           Case_Map (Index).Upper = Value;
      else
         return False;
      end if;
   end Has_Case;
   ...
   begin
      Find (Value, Found, Index);
      if Found then
         return Case_Map (Index).Lower = Value;
      else
         return False;
      end if;
   end Is_Lowercase;
   ...
   begin
      Find (Value, Found, Index);
      if Found then
         return Case_Map (Index).Upper = Value;
      else
         return False;
      end if;
   end Is_Uppercase;

...
private
   ...
   procedure Get
     (Source  : in String;
      ...
      Last    : Number'Base := Number'Last;
      ToFirst : Boolean     := False;
      ToLast  : Boolean     := False) renames Edit.Get;
   ...
   function Value
     (Source  : in String;
      ...
      Last    : Number'Base    := Number'Last;
      ToFirst : Boolean        := False;
      ToLast  : Boolean        := False) return Number'Base renames Edit.Value;
   ...
   procedure Put
     (Destination : in out String;
      ...
      Value       : Number'Base;
      Base        : Script_Base := 10;
      PutPlus     : Boolean     := False) renames Edit.Put;

   function Image
     (Value   : Number'Base;
      Base    : Script_Base := 10;
      PutPlus : Boolean     := False) return String renames Edit.Image;

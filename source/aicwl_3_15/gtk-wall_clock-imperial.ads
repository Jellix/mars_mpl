...
package Gtk.Wall_Clock.Imperial is
   ...
   function Get_Hour_Hand
     (Widget : not null access Gtk_Wall_Clock_Imperial_Record)
      return not null access Gtk.Layered.Clock_Hand.Clock_Hand_Layer;
   ...
   type Gtk_Wall_Clock_Imperial_Record is
     new Gtk.Layered.Gtk_Layered_Record with
      record
         ...
         Hour_Needle   : access Gtk.Layered.Clock_Hand.Clock_Hand_Layer;
         Minute_Needle : access Gtk.Layered.Clock_Hand.Clock_Hand_Layer;
      end record;

...
package Gdk.Color.IHLS is
   ...
   function Darken
     (Color : Gdk_IHLS_Color;
      By    : Gdk_Luminance) return Gdk_IHLS_Color with Inline;

   function Darken
     (Color : Gdk_Color;
      By    : Gdk_Luminance) return Gdk_Color with Inline;
   ...
   function Lighten
     (Color    : Gdk_Color;
      By       : Gdk_Luminance;
      Impurify : Boolean := False) return Gdk_Color with Inline;
   ...
   function Impurify
     (Color : Gdk_IHLS_Color;
      By    : Gdk_Saturation) return Gdk_IHLS_Color with Inline;

   function Impurify
     (Color : Gdk_Color;
      By    : Gdk_Saturation) return Gdk_Color with Inline;
   ...
   --
   function To_RGB (Stimulus : Gdk_Stimulus) return Guint16 with Inline;
   ...
   function To_RGB
     (Red   : Gdk_Stimulus;
      Green : Gdk_Stimulus;
      Blue  : Gdk_Stimulus) return Gdk_Color with Inline;

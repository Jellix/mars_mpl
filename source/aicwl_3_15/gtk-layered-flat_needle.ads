...
package Gtk.Layered.Flat_Needle is
   ...
   --    The needle's color
   --
   function Get_Color (Layer : Flat_Needle_Layer) return Gdk.Color.Gdk_Color;
   ...
   --
   function Get_From
     (Layer : Flat_Needle_Layer) return Cairo.Ellipses.Cairo_Tuple;
   ...
   overriding function Get_Adjustment
     (Layer : Flat_Needle_Layer) return Gtk.Adjustment.Gtk_Adjustment;
   ...
   overriding function Get_Properties_Number
     (Layer : Flat_Needle_Layer) return Natural;
   ...
   overriding function Get_Scaled (Layer : Flat_Needle_Layer) return Boolean;

   overriding function Get_Value (Layer : Flat_Needle_Layer) return Gdouble;

   overriding function Is_Updated (Layer : Flat_Needle_Layer) return Boolean;

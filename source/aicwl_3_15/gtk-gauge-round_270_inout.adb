...
package body Gtk.Gauge.Round_270_Inout is
   ...
   Pin_Color         : constant Gdk.Color.Gdk_Color := Gtk.Missed.RGB (0.3, 0.3, 0.3);
   Background_Color  : constant Gdk.Color.Gdk_Color := Gtk.Missed.RGB (0.0, 0.0, 0.0);
   Line_Color        : constant Gdk.Color.Gdk_Color := Gtk.Missed.RGB (0.6, 1.0, 1.0);
   Major_Tick_Color  : constant Gdk.Color.Gdk_Color := Background_Color;
   Middle_Tick_Color : constant Gdk.Color.Gdk_Color := Line_Color;
   Minor_Tick_Color  : constant Gdk.Color.Gdk_Color := Background_Color;
   Major_Text_Color  : constant Gdk.Color.Gdk_Color := Line_Color;
   Minor_Text_Color  : constant Gdk.Color.Gdk_Color := Line_Color;
   ...
   procedure Create_Background
     (Widget  : not null access Gtk_Gauge_Round_270_Inout_Record'Class;
      Sectors : Positive)
   is
   ...
   overriding procedure Style_Changed
     (Widget : not null access Gtk_Gauge_Round_270_Inout_Record) is
   begin
      ...
      Widget.all.Line.all.Set
        (Ellipse => Widget.all.Line.all.Get_Ellipse,
         From    => Widget.all.Line.all.Get_From,
         Length  => Widget.all.Line.all.Get_Length,
         Line    =>
           (Widget.all.Line.all.Get_Line.Width,
            Gtk.Widget.Styles.Style_Get (Widget, "line-color", Line_Color),
            Widget.all.Line.all.Get_Line.Line_Cap));

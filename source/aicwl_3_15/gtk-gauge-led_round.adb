...
package body Gtk.Gauge.LED_Round is
   ...
   protected Lock is
      function On_Color
        (LED : Gtk_Gauge_LED_Round_Record'Class) return Gdk_Color;
      function Off_Color
        (LED : Gtk_Gauge_LED_Round_Record'Class)  return Gdk_Color;
      procedure Set (LED : in out Gtk_Gauge_LED_Round_Record'Class;
                     On  : Gdk_Color;
                     Off : Gdk_Color);
   end Lock;
   ...
   protected body Lock  is
      function Off_Color
        (LED : Gtk_Gauge_LED_Round_Record'Class)  return Gdk_Color is
      begin
         return LED.Off;
      end Off_Color;
   ...
   function Get_Background (Widget : not null access Gtk_Gauge_LED_Round_Record)
   ...
   procedure Gtk_New (Widget        : out Gtk_Gauge_LED_Round;
                      ...
                      Border_Shadow : Gtk_Shadow_Type := Shadow_In) is
   begin
      ...
      Widget.all.Shadow :=
        Add_Line
          (Under    => Widget.all.Background.all.Get_Foreground,
           ...
           Scaled   => True,
           Widened  => True,
           Color    => Darken (Lock.Off_Color (Widget.all), Shadow_Shift));

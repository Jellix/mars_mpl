   ...
   type Gtk_Gauge_Round_270_Inout_Record is
     new Gtk.Layered.Gtk_Layered_Record with
      record
         ...
         Line             : access Gtk.Layered.Arc.Arc_Layer;
         ...
         Major_Annotation : access Gtk.Layered.Elliptic_Annotation.Elliptic_Annotation_Layer;
         Minor_Annotation : access Gtk.Layered.Elliptic_Annotation.Elliptic_Annotation_Layer;

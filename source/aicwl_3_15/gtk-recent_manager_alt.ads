...
package Gtk.Recent_Manager_Alt is
   ...
   --
   function Get_Added (Info : Gtk_Recent_Info) return Ada.Calendar.Time;
   ...
   --    Time_Error - No time available
   --
   function Get_Modified (Info : Gtk_Recent_Info) return Ada.Calendar.Time;
   ...
   --    Time_Error - No time available
   --
   function Get_Visited (Info : Gtk_Recent_Info) return Ada.Calendar.Time;

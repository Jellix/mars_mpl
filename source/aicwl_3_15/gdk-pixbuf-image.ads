...
package Gdk.Pixbuf.Image is
   ...
   --
   function From_Pixel (Pixel : RGB_Pixel) return Gdk.Color.Gdk_Color;
   ...
   --
   function To_Pixel (Color : Gdk.Color.Gdk_Color) return RGB_Pixel;
...
private
   ...
   overriding procedure Adjust (Image : in out RGB_Image);

   overriding procedure Finalize (Image : in out RGB_Image);

...
package body Gtk.Wall_Clock.Imperial is
   ...
   begin
      ...
      if
        ...
        Widget.all.Minute_Needle.all.Is_Updated -- Signal draw to the widget
      then
         Queue_Draw (Widget);
      end if;
   end Changed;
   ...
   function Get_Hour_Hand
     (Widget : not null access Gtk_Wall_Clock_Imperial_Record)
      return not null access Gtk.Layered.Clock_Hand.Clock_Hand_Layer is
   begin
   ...
   procedure Initialize
     (Widget     : not null access Gtk_Wall_Clock_Imperial_Record'Class;
      ...
      Widget.all.Background :=
        Gtk.Layered.Elliptic_Background.Add_Elliptic_Background
          (Under         => Widget,
           ...
           Border_Color  => (False, Gtk.Missed.RGB (0.94, 0.69, 0.0)),
           Deepened      => True,
           Widened       => True,
           Scaled        => True);
      Widget.all.Line_1 :=
   ...
   overriding procedure Style_Changed
     (Widget : not null access Gtk_Wall_Clock_Imperial_Record) is
   begin
      Widget.all.Hour_Needle.all.Set
        (Center        => Widget.all.Hour_Needle.all.Get_Center,
         ...
         Bulb_Position => Widget.all.Hour_Needle.all.Get_Bulb_Position,
         Bulb_Radius   => Widget.all.Hour_Needle.all.Get_Bulb_Radius,
         Bulb_Width    => Widget.all.Hour_Needle.all.Get_Bulb_Width,
         Color         =>
      ...
      Widget.all.Minute_Needle.all.Set
        (Center => Widget.all.Minute_Needle.all.Get_Center,
         ...
         Rear   =>
           (Length => Widget.all.Minute_Needle.all.Get_Rear.Length,
            Width  => Widget.all.Minute_Needle.all.Get_Rear.Width,
            Cap    =>
              Gtk.Widget.Styles.Line_Cap_Property.Style_Get
                (Widget, "minute-needle-rear-cap")),
         Bulb_Position => Widget.all.Minute_Needle.all.Get_Bulb_Position,
         Bulb_Radius   => Widget.all.Minute_Needle.all.Get_Bulb_Radius,
         Bulb_Width    => Widget.all.Minute_Needle.all.Get_Bulb_Width,
         Color         =>
           Gtk.Widget.Styles.Style_Get

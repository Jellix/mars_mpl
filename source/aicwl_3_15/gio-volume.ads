...
package GIO.Volume is
   ...
   type GVolume_Record is new Glib.Object.GObject_Record with null record;
   ...
   function Convert (Volume  : GVolume) return System.Address;

   function Convert (Pointer : System.Address) return GVolume;

...
package Gtk.Tree_Model.Columned_Store is
   ...
   type Gtk_Columned_Store_Record is
     new Gtk.Tree_Model.Abstract_Store.Gtk_Abstract_Model_Record with private;
   ...
   function Get_Major_Columns
     (Model : not null access Gtk_Columned_Store_Record) return Positive;

   --
   -- Get_N_Columns -- Overrides Gtk.Tree_Model.Abstract_Store...
   --
   overriding function Get_N_Columns
     (Model : not null access Gtk_Columned_Store_Record) return Gint;
   ...
   function Get_Reference
     (Model : not null access Gtk_Columned_Store_Record) return Gtk_Tree_Model;
   ...
   --
   function Get_Root
     (Model : not null access Gtk_Columned_Store_Record) return Gtk_Tree_Iter;

   function Get_Root
     (Model : not null access Gtk_Columned_Store_Record) return Gtk_Tree_Path;
...
private
   ...
   type Callback_ID is array (Row_Callbacks) of Gtk.Handlers.Handler_Id;
